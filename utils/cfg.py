...
def parse_args(mode='train'):
    ...
    if mode == 'train':
        ...
        # lr decay
        parser.add_argument('-lr_decay', type=str, default='constant', choices=['constant', '1cycle'],
                            help='how learning rate decays')

        parser.add_argument('-wd', default=5e-4, type=float, help='weight decay')
        parser.add_argument('-pct_start', default=0.10, type=float,
                            help='The percentage of the cycle (in number of steps) spent increasing the learning rate. Default: 0.3')
        parser.add_argument('-div_factor', default=10, type=float,
                            help="Determines the initial learning rate via initial_lr = max_lr/div_factor Default: 25")
        parser.add_argument('-final_div_factor', default=30, type=float,
                            help="Determines the minimum learning rate via min_lr = initial_lr/final_div_factor Default: 1e4")
    ...
    parser.add_argument('-dataset_name', type=str, default='sbu', choices=['sbu', 'sbu_new', 'ucf', 'istd', 'cuhk'],
                        help='dataset')
    parser.add_argument('-backbone', default='b5', type=str, choices=['b0', 'b1', 'b2', 'b3', 'b4', 'b5', 'resnext'],
                        help='backbone for efficientnet')
    parser.add_argument('-logger', default='tensorboard', type=str, choices=['wandb', 'tensorboard'],
                        help='type of logger')
    # amp
    ...
    parser.add_argument('-type', type=str, default='gen_pt', choices=['gt_pt', 'gen_mask', 'gen_pt', 'gen_mask_pt'],
                        help='type for prompt')
